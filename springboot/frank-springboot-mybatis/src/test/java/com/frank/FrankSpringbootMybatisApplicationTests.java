...
@SpringBootTest
public class FrankSpringbootMybatisApplicationTests {

    private static final Logger log = LoggerFactory.getLogger(FrankSpringbootMybatisApplicationTests.class);
    @Autowired
